...
class EnterpriseSearchJavaApplicationTests {
    ...
    void serializeFacets(){
        ...
        request = new SearchApiRequest();
        request.getFacets().put("location",List.of(new SearchRangeFacet().setName("geo-range-from-san-francisco").setCenter(new GeoLocation(new BigDecimal("37.386483"),new BigDecimal("-122.083842"))).setUnit("m").setRanges(List.of(
